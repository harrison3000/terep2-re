...
.LAB_LOC_18:
    ...
    JL          .LAB_LOC_19
    MOV         BX,word [DI + 0x6]
    mov_m2m     word [ye_old_lil_bep],word [DI + 0x8]
    LODSW 
    CWD
    IDIV        CX
    MOV         DX,AX
...
.LAB_LOC_22:
    ...
    mov_m2m     word [ye_old_lil_bep],word [BX + 0x12e]
    PUSH        DX
...
FUN_1000_22f0:
    ...
    PUSH        SI
    ADD         SI,word [SI]
    mov_m2m     word [ye_old_lil_bep],word [SI]
    ADD         SI,0x2
    MOV         BX,0x0
    MOV         CX,0x7f7f
.LAB_LOC_1:
...
.LAB_LOC_1:
    ...
    mov_m2m     word [ye_old_lil_bep],word [BX + 0xdee8]
...
FUN_1000_324f:
    ...
    MOV         AX,word [SI]
    MOV         BX,word [SI + 0x2]
    mov_m2m     word [ye_old_lil_bep],word [SI + 0x4]
    MOV         word [DI],AX
    MOV         word [DI + 0x2],BX
    mov_m2m     word [DI + 0x4],word [ye_old_lil_bep]
    POP         DI
    ADD         SI,0x8
    CMP         AX,word [0xdbc0]
    JL          .LAB_LOC_6
...
.LAB_LOC_2:
    ...
    MOV         AX,word [SI + 0x4]
    MOV         BX,word [SI + 0x6]
    mov_m2m     word [ye_old_lil_bep],word [SI + 0x2]
    POP         SI
    MOV         CX,word [SI + 0x4]
    MOV         DX,word [SI + 0x6]
    MOV         DI,word [SI + 0x2]
...
.LAB_LOC_1:
    ...
    mov_m2m     word [ye_old_lil_bep],word [SI + 0xe208]
...
.LAB_LOC_1:
    ...
    MOV         word [SI],AX
    MOV         word [SI + 0x2],BX
    mov_m2m     word [SI + 0x4],word [ye_old_lil_bep]
    MOV         word [SI + 0x6],DI
    ADD         SI,0x8
    INC         word [0xe528]
    SHL         EAX,0x10
...
FUN_1000_46d3:
    ...
    MOV         EAX,dword [SI + 0x6]
    MOV         dword [DI + 0xdb16],EAX
    mov_m2m     dword [DI + 0xdb1a],dword [ye_old_bep]
    ADD         DI,0x8
    MOV         word [0xe996],DI
    POP         DI
    MOV         AX,word [SI]
