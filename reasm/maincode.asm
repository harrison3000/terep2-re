...
LAB_1000_0046:                ;XREF[1]:     1000:001b(j)
    ...
    MOV         AX,0x15cd
    MOV         DS,AX
    MOV         word [0x0073],0x693   ;= 0693h
    MOV         word [0x0075],0x73f   ;= 073Fh
    MOV         word [0x0077],0x828   ;= 0828h
    MOV         word [0x0079],0x893   ;= 0893h
    MOV         word [0x007b],0x948   ;= 0948h
    JMP         LAB_1000_00dc
...
LAB_1000_021c:                ;XREF[1]:     1000:01ad(j)
    ...
    CALL        fun_setup_interrupts                    ;undefined fun_setup_interrupts()
...
LAB_1000_0258:                ;XREF[2]:     1000:05a9(j),1000:05b2(j)
    ...
    CALL        word [BX + 0x73]=>CODE_1:DAT_15cd...;undefined FUN_CAM_1000_0893()
                                                        ;= 0893h
    MOV         BX,word [0x00c6]
...
LAB_1000_0322:                ;XREF[1]:     1000:031c(j)
    ...
    CALL        word [0x006f]         ;undefined FUN_1000_5b01()
    JMP         LAB_1000_04b7
...
LAB_1000_055d:                ;XREF[2]:     1000:054a(j),1000:0554(j)
    MOV         AL,CS:[BYTE_ARRAY_1000_571e]
    CMP         AL,0x1
    JZ          LAB_1000_0654
    CMP         AL,0xf
    JZ          LAB_1000_05f4
...
LAB_1000_05ac:                ;XREF[11]:    1000:05bb(j),1000:05c3(j),1000:05cb(j),1000:05d3(j),
    ...
    MOV         byte CS:[BYTE_ARRAY_1000_571e],0x0
    JMP         LAB_1000_0258
...
LAB_1000_0a54:                ;XREF[1]:     1000:0a43(j)
    PUSHF
    AND         byte CS:[BYT...,0x3f
    MOV         SI,word [0xa4]
    SHL         SI,0x1
    MOV         SI,word [SI + 0x5bbc]
    POPF
    CALL        FUN_1000_0a82                           ;undefined FUN_1000_0a82()
    JMP         LAB_1000_0a47
...
FUN_1000_0d2a:
                              ;XREF[1]:     1000:56b4(c)
    MOVZX       BX,byte [DI]
    MOV         AL,byte CS:[BX + 0x571e]
    MOVZX       BX,byte [DI + 0x1]
    MOV         AH,byte CS:[BX + 0x571e]
    MOV         BX,word [SI + 0xc]
    MOV         CX,0x32
    TEST        AL,0x80
    JS          LAB_1000_0d5a
...
FUN_1000_0e28:
    ...
    ADD         AX,BX
    MOV         word [SI + 0x14],AX
    MOV         word CS:[DAT_1000_0e67],0x0
    RET
DAT_1000_0e67:                ;XREF[9]:     1000:0e5f(W),1000:0e8f(R),1000:0e9d(RW),1000:0eb9(R),
...
LAB_1000_0e8f:                ;XREF[1]:     1000:0e6c(j)
    TEST        word CS:[DAT_1000_0e67],0x1
    JNZ         LAB_1000_0ea3
    NOP
    NOP
    CALL        FUN_1000_1136                           ;undefined FUN_1000_1136()
    OR          word CS:[DAT_1000_0e67],0x1
LAB_1000_0ea3:                ;XREF[1]:     1000:0e96(j)
    MOV         EAX,CS:[DAT_1000_12a7]
    MOV         EBX,dword CS:[DAT_1000_12ab]
    MOV         ECX,dword CS:[DAT_1000_12af]
...
LAB_1000_0ee3:                ;XREF[1]:     1000:0e7a(j)
    TEST        word CS:[DAT_1000_0e67],0x2
    JNZ         LAB_1000_0f0f
    NOP
    NOP
    PUSH        SI
    ...
    MOV         dword CS:[DAT_1000_12c3],EBX
    MOV         dword CS:[DAT_1000_12c7],ECX
    POP         SI
    OR          word CS:[DAT_1000_0e67],0x2
LAB_1000_0f0f:                ;XREF[1]:     1000:0eea(j)
    MOV         EAX,CS:[DAT_1000_12bf]
    MOV         EBX,dword CS:[DAT_1000_12c3]
    MOV         ECX,dword CS:[DAT_1000_12c7]
...
FUN_1000_1136:
    ...
    MOV         dword CS:[DAT_1000_12b7],EBX
    MOV         dword CS:[DAT_1000_12bb],ECX
    CALL        FUN_1000_10b6                           ;undefined FUN_1000_10b6()
    MOV         CS:[DAT_1000_12bf],EAX
    MOV         dword CS:[DAT_1000_12c3],EBX
    MOV         dword CS:[DAT_1000_12c7],ECX
    ...
    MOV         EAX,CS:[DAT_1000_12bf]
    IMUL        dword CS:[DAT_1000_12a3]            ;= 7FFF0000h
    MOV         EBX,EDX
    MOV         EAX,CS:[DAT_1000_12b3]
    IMUL        dword CS:[DAT_1000_129f]
    SUB         EBX,EDX
    SHL         EBX,0x1
    MOV         dword CS:[DAT_1000_12a7],EBX
    ...
    SUB         EBX,EDX
    SHL         EBX,0x1
    MOV         dword CS:[DAT_1000_12ab],EBX
    ...
    SUB         EBX,EDX
    SHL         EBX,0x1
    MOV         dword CS:[DAT_1000_12af],EBX
    RET
;************************************************************************************************
;*                                           FUNCTION                                           *
;************************************************************************************************
FUN_1000_11f0:
    ...
    POP         EAX
    RET
DAT_1000_129f:                ;XREF[8]:     1000:116f(W),1000:1193(R),1000:11b8(R),1000:11dd(R),
                              ;             1000:1229(W),1000:123f(R),1000:1261(R),1000:1281(R)
    undefined4  00000000h
DAT_1000_12a3:                ;XREF[8]:     1000:117b(W),1000:1185(R),1000:11aa(R),1000:11cf(R),
                              ;             1000:1235(W),1000:124d(R),1000:126f(R),1000:128f(R)
    undefined4  7FFF0000h
DAT_1000_12a7:                ;XREF[3]:     1000:0ea3(R),1000:0ecd(R),1000:119f(W)
    undefined4  00000000h
DAT_1000_12ab:                ;XREF[3]:     1000:0ea8(R),1000:0ed2(R),1000:11c4(W)
    undefined4  00000000h
DAT_1000_12af:                ;XREF[3]:     1000:0eae(R),1000:0ed8(R),1000:11e9(W)
    undefined4  00000000h
DAT_1000_12b3:                ;XREF[4]:     1000:113f(W),1000:118e(R),1000:11f9(W),1000:1248(R)
    undefined4  00000000h
DAT_1000_12b7:                ;XREF[4]:     1000:1144(W),1000:11b3(R),1000:11fe(W),1000:126a(R)
    undefined4  00000000h
DAT_1000_12bb:                ;XREF[4]:     1000:114a(W),1000:11d8(R),1000:1204(W),1000:128a(R)
    undefined4  00000000h
DAT_1000_12bf:                ;XREF[8]:     1000:0ef7(W),1000:0f0f(R),1000:0f39(W),1000:0f51(R),
                              ;             1000:1153(W),1000:1180(R),1000:120d(W),1000:123a(R)
    undefined4  00000000h
DAT_1000_12c3:                ;XREF[8]:     1000:0efc(W),1000:0f14(R),1000:0f3e(W),1000:0f56(R),
                              ;             1000:1158(W),1000:11a5(R),1000:1212(W),1000:125c(R)
    undefined4  00000000h
DAT_1000_12c7:                ;XREF[8]:     1000:0f02(W),1000:0f1a(R),1000:0f44(W),1000:0f5c(R),
...
LAB_1000_143e:                ;XREF[1]:     1000:1435(*)
    LODSW       SI
    ADD         SI,AX
    JMP         FUN_1000_1408                           ;undefined FUN_1000_1408()
...
LAB_1000_15a1:                ;XREF[1]:     1000:15bb(j)
    ...
    POP         SI
    JS          FUN_1000_1408
    CALL        FUN_1000_30ee                           ;undefined FUN_1000_30ee()
    JMP         FUN_1000_1408                           ;undefined FUN_1000_1408()
...
FUN_1000_30ee:
    ...
    MOV         SI,0xdb16
    MOV         DI,0xdb68
    CALL        FUN_1000_324f                           ;undefined FUN_1000_324f()
    XCHG        DI,SI
    CALL        FUN_1000_3376                           ;undefined FUN_1000_3376()
    XCHG        DI,SI
    CALL        FUN_1000_34a2                           ;undefined FUN_1000_34a2()
    XCHG        DI,SI
    CALL        FUN_1000_35cf                           ;undefined FUN_1000_35cf()
    MOV         SI,DI
    MOV         CX,word [SI + -0x2]
    CMP         CX,0x3
    JC          LAB_1000_317a
...
LAB_1000_314f:                ;XREF[1]:     1000:3165(j)
    ...
    MOV         CX,word [SI + 0xc]
    MOV         DX,word [SI + 0xa]
    CALL        FUN_1000_317d                           ;undefined FUN_1000_317d()
    POP         SI
    POP         CX
    ADD         SI,0x8
    LOOP        LAB_1000_314f
    ...
    MOV         DX,word [SI + 0x2]
    CALL        FUN_1000_317d                           ;undefined FUN_1000_317d()
    CALL        FUN_1000_31d1                           ;undefined FUN_1000_31d1()
...
FUN_1000_48d0:
                              ;XREF[1]:     1000:56ba(c)
    PUSH        SI
    CALL        FUN_1000_4e0a                           ;undefined FUN_1000_4e0a()
    POP         SI
    PUSH        SI
    CALL        FUN_1000_48db                           ;undefined FUN_1000_48db()
    POP         SI
    RET
;************************************************************************************************
;*                                           FUNCTION                                           *
...
FUN_1000_48db:
                              ;XREF[1]:     1000:48d6(c)
    CALL        FUN_1000_0e28                           ;undefined FUN_1000_0e28()
    MOV         DI,SI
    ADD         DI,word [SI]
    MOV         AX,word [DI]
    MOV         [0xe9d4],AX
...
LAB_1000_48f0:                ;XREF[1]:     1000:4976(j)
    ...
    SHR         ECX,0x10
    PUSH        CX
    CALL        FUN_1000_532e                           ;undefined FUN_1000_532e()
    POP         CX
    ADD         AX,word [DI + 0x18]
    MOV         [0xe9c6],AX
    CMP         AX,CX
...
LAB_1000_4954:                ;XREF[1]:     1000:4a0a(j)
    ...
    DEC         word [0xe9d4]
    JNZ         LAB_1000_48f0
    CALL        FUN_1000_1003                           ;undefined FUN_1000_1003()
    RET
LAB_1000_497e:                ;XREF[1]:     1000:4929(j)
    ...
    MOV         byte [0xea28],0x0
    NOP
    CALL        FUN_1000_4a71                           ;undefined FUN_1000_4a71()
    JMP         LAB_1000_492d
...
FUN_1000_4a71:
    ...
    NOP
    XOR         AX,AX
    CALL        FUN_1000_5864                           ;undefined FUN_1000_5864()
...
LAB_1000_4b26:                ;XREF[1]:     1000:4b23(j)
    ...
    MOV         AX,[0xe9d6]
    CALL        FUN_1000_0e69                           ;undefined FUN_1000_0e69()
    MOV         [0xe9b0],EAX
    MOV         dword [0xe9b4],EBX
    MOV         dword [0xe9b8],ECX
    NEG         EDX
    MOV         dword [0xe9da],EDX
    CALL        FUN_1000_4c26                           ;undefined FUN_1000_4c26()
    MOV         [0xe9bc],AX
    MOV         BX,AX
    CALL        FUN_1000_2ad8                           ;undefined FUN_1000_2ad8()
    SHL         EAX,0x10
    ...
    CALL        FUN_1000_4d0e                           ;undefined FUN_1000_4d0e()
    MOV         EBX,dword [0xe9da]
    NEG         EBX
    MOV         AX,[0xe9d6]
    CALL        FUN_1000_0f67                           ;undefined FUN_1000_0f67()
...
LAB_1000_4bdc:                ;XREF[2]:     1000:4b18(j),1000:4bd9(j)
    ...
    ADD         EBX,EDX
    MOV         dword [0xe9d0],EBX
    CALL        FUN_1000_4cc3                           ;undefined FUN_1000_4cc3()
    RET
;************************************************************************************************
;*                                           FUNCTION                                           *
;************************************************************************************************
...
FUN_1000_4cc3:
                              ;XREF[1]:     1000:4c22(c)
    CALL        FUN_1000_4c68                           ;undefined FUN_1000_4c68()
    JG          LAB_1000_4ce8
    NOP
    NOP
    PUSH        ECX
    CALL        FUN_1000_4d96                           ;undefined FUN_1000_4d96()
    POP         ECX
    MOV         EAX,[0xe9d0]
    CDQ
    IDIV        ECX
...
LAB_1000_5018:                ;XREF[1]:     1000:508e(j)
    ...
    PUSH        DI
    MOV         SI,word [DI]
    CALL        FUN_1000_5091                           ;undefined FUN_1000_5091()
    MOV         DI,0x5bbc
    MOV         CX,word [0x5bba]
LAB_1000_5026:                ;XREF[1]:     1000:5087(j)
    ...
    POP         DI
    POP         SI
    CALL        FUN_1000_51bd                           ;undefined FUN_1000_51bd()
    JMP         LAB_1000_5082
...
FUN_1000_532e:
    ...
    MOV         [0xea26],AX
    PUSH        CX
    CALL        FUN_1000_52d4                           ;undefined FUN_1000_52d4()
    POP         CX
    ADD         AX,CX
    JMP         LAB_1000_53ea
...
fun_setup_interrupts:
    ...
    STOSB.REP   ES:DI=>BYTE_ARRAY_1000_571e
    POP         ES
    CLI
    IN          AL,0x21
    ...
    MOV         BX,word FS:[0x20]
    POP         FS
    MOV         word CS:[DAT_1000_5532],BX
    MOV         word CS:[DAT_1000_5534],ES
    MOV         AX,CS
    MOV         DS,AX
    MOV         DX,0x5680
    PUSH        FS
    ...
    MOV         AX,0x3509
    INT         0x21
    MOV         word CS:[DAT_1000_5536],BX
    MOV         word CS:[DAT_1000_5538],ES
    MOV         AX,CS
    MOV         DS,AX
    MOV         DX,0x56df
    MOV         AX,0x2509
    ...
    MOV         AX,0x3500
    INT         0x21
    MOV         word CS:[DAT_1000_552e],BX
    MOV         word CS:[DAT_1000_5530],ES
    MOV         AX,CS
    MOV         DS,AX
    MOV         DX,0x553f
    MOV         AX,0x2500
    ...
    MOV         AX,0x35f1
    INT         0x21
    MOV         word CS:[DAT_1000_553a],BX
    MOV         word CS:[DAT_1000_553c],ES
    MOV         AX,CS
    MOV         DS,AX
    MOV         DX,0x579e
    MOV         AX,0x25f1
...
LAB_1000_56ad:                ;XREF[1]:     1000:56c6(j)
    ...
    PUSH        BP
    MOV         DI,BP
    CALL        FUN_1000_0d2a                           ;undefined FUN_1000_0d2a()
    CALL        FUN_1000_1004                           ;undefined FUN_1000_1004()
    CALL        FUN_1000_48d0                           ;undefined FUN_1000_48d0()
    POP         BP
    POP         DI
    POP         CX
    ADD         DI,0x2
    ADD         BP,0x6
    LOOP        LAB_1000_56ad
    CALL        FUN_1000_500b                           ;undefined FUN_1000_500b()
    CALL        FUN_1000_0bb5                           ;undefined FUN_1000_0bb5()
    CALL        FUN_1000_0a3b                           ;undefined FUN_1000_0a3b()
...
FUN_keyboard_56df:
    ...
    NOP
    NOP
    MOV         byte CS:[BX + 0x571e],0xff
    NOP
    MOV         byte CS:[BYTE_ARRAY_1000_571e],0x0
    NOP
    JMP         LAB_1000_570a
LAB_1000_56ff:                ;XREF[1]:     1000:56eb(j)
    AND         byte CS:[BX + 0x571e],0x7f
    MOV         byte CS:[BYTE_ARRAY_1000_571e],BL
LAB_1000_570a:                ;XREF[1]:     1000:56fd(j)
    ...
    STI
    IRET
BYTE_ARRAY_1000_571e:         ;XREF[14,9]:  1000:04fa(R),1000:0513(R),1000:052b(R),1000:0544(R),
...
FUN_1000_5940:
    ...
    MOV         byte CS:[DAT_1000_59c1],CL          ;= 0Fh
    MOV         CX,AX
    CLD
...
LAB_1000_59a6:                ;XREF[1]:     1000:599b(j)
    PUSH        AX
    PUSH        BX
    MOV         CL,byte CS:[DAT_1000_59c1]          ;= 0Fh
    CALL        FUN_1000_3f98                           ;undefined FUN_1000_3f98()
    POP         BX
    POP         AX
    INC         BX
