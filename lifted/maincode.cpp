...
void FUN_1000_1408(cpu_ctx *cpu){
   ...
   INST_LODSW();
   cpu->CL = cpu->AL;
   if (undefined) goto L_1408_START;
...
void FUN_1000_2b2d(cpu_ctx *cpu){
   ...
   INST_CMP(cpu->AX, cpu->BX);
   if (undefined) goto LAB_LOC_1;
   if (undefined) goto FUN_1000_2b3b;
   cpu->AX = 0x2000;
   return;
