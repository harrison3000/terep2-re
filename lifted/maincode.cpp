...
//old:COMP«CMP, cpu->BX, MEM_WORD(0xe58c)»
   if(CMP_L) goto LAB_LOC_5;
//old:COMP«CMP, cpu->BX, MEM_WORD(0xe58e)»
   if(CMP_G) goto LAB_LOC_5;
   INST_SHL(cpu->BX, 0x2);
...
//old:COMP«CMP, cpu->DL, MEM_BYTE(cpu->SI + -0x4)»
   if(CMP_BE) goto LAB_LOC_5;
//old:COMP«CMP, cpu->DL, MEM_BYTE(cpu->SI + -0x2)»
   if(CMP_A) goto LAB_LOC_5;
   INST_PUSH(cpu->SI);
   INST_PUSH(cpu->DI);
   INST_SUB(cpu->DI, 0xa);
   cpu->SI = cpu->DI;
...
//old:COMP«CMP, cpu->DL, MEM_BYTE(cpu->SI + -0x4)»
   if(CMP_C) goto LAB_LOC_9;
//old:COMP«CMP, cpu->DL, MEM_BYTE(cpu->SI + -0x2)»
   if(CMP_NC) goto LAB_LOC_9;
   INST_PUSH(cpu->SI);
   INST_PUSH(cpu->DI);
   cpu->SI = cpu->DI;
   INST_SUB(cpu->DI, MEM_WORD(0x19ff));
...
//old:COMP«CMP, cpu->DL, MEM_BYTE(cpu->SI + 0x4)»
   if(CMP_BE) goto LAB_LOC_17;
//old:COMP«CMP, cpu->DL, MEM_BYTE(cpu->SI + 0x6)»
   if(CMP_A) goto LAB_LOC_17;
   INST_PUSH(cpu->SI);
   INST_PUSH(cpu->DI);
   INST_SUB(cpu->DI, 0xa);
   cpu->SI = cpu->DI;
...
//old:COMP«CMP, cpu->DL, MEM_BYTE(cpu->SI + 0x4)»
   if(CMP_C) goto LAB_LOC_21;
//old:COMP«CMP, cpu->DL, MEM_BYTE(cpu->SI + 0x6)»
   if(CMP_NC) goto LAB_LOC_21;
   INST_PUSH(cpu->SI);
   INST_PUSH(cpu->DI);
   cpu->SI = cpu->DI;
   INST_SUB(cpu->SI, MEM_WORD(0x19ff));
...
//old:COMP«CMP, cpu->DH, MEM_BYTE(cpu->SI + -0x4)»
   if(CMP_BE) goto LAB_LOC_6;
//old:COMP«CMP, cpu->DH, MEM_BYTE(cpu->SI + -0x2)»
   if(CMP_A) goto LAB_LOC_6;
   INST_PUSH(cpu->SI);
   INST_PUSH(cpu->DI);
   INST_SUB(cpu->DI, 0xa);
   cpu->SI = cpu->DI;
...
//old:COMP«CMP, cpu->DH, MEM_BYTE(cpu->SI + -0x4)»
   if(CMP_C) goto LAB_LOC_10;
//old:COMP«CMP, cpu->DH, MEM_BYTE(cpu->SI + -0x2)»
   if(CMP_NC) goto LAB_LOC_10;
   INST_PUSH(cpu->SI);
   INST_PUSH(cpu->DI);
   cpu->SI = cpu->DI;
   INST_SUB(cpu->DI, MEM_WORD(0x19ff));
...
//old:COMP«CMP, cpu->DH, MEM_BYTE(cpu->SI + 0x4)»
   if(CMP_BE) goto LAB_LOC_18;
//old:COMP«CMP, cpu->DH, MEM_BYTE(cpu->SI + 0x6)»
   if(CMP_A) goto LAB_LOC_18;
   INST_PUSH(cpu->SI);
   INST_PUSH(cpu->DI);
   INST_SUB(cpu->DI, 0xa);
   cpu->SI = cpu->DI;
...
//old:COMP«CMP, cpu->DH, MEM_BYTE(cpu->SI + 0x4)»
   if(CMP_C) goto LAB_LOC_22;
//old:COMP«CMP, cpu->DH, MEM_BYTE(cpu->SI + 0x6)»
   if(CMP_NC) goto LAB_LOC_22;
   INST_PUSH(cpu->SI);
   INST_PUSH(cpu->DI);
   cpu->SI = cpu->DI;
   INST_SUB(cpu->SI, MEM_WORD(0x19ff));
...
void FUN_1000_2431(cpu_ctx *cpu){
   ...
   LAB_LOC_1:
//old:COMP«CMP, MEM_WORD(cpu->DI + 0x1a), -0x1»
...
//old:COMP«CMP, cpu->AX, cpu->BX»
   if(CMP_G) goto LAB_LOC_1;
   if(CMP_L) goto FUN_1000_2b3b;
   cpu->AX = 0x2000;
   return;
...
//old:COMP«CMP, cpu->BX, cpu->CX»
   if(CMP_LE) goto LAB_LOC_3;
   INST_XCHG(cpu->AX, cpu->DX);
   INST_XCHG(cpu->CX, cpu->BX);
//old:COMP«CMP, cpu->BX, MEM_WORD(0xdbc4)»
   if(CMP_GE) goto LAB_LOC_1;
...
//old:COMP«CMP, cpu->CX, MEM_WORD(0xdbc6)»
   ...
   LAB_LOC_3:
//old:COMP«CMP, cpu->BX, MEM_WORD(0xdbc4)»
   if(CMP_GE) goto LAB_LOC_4;
   MEM_WORD(0xdbc4) = cpu->BX;
   LAB_LOC_4:
//old:COMP«CMP, cpu->CX, MEM_WORD(0xdbc6)»
   if(CMP_LE) goto LAB_LOC_5;
   MEM_WORD(0xdbc6) = cpu->CX;
   LAB_LOC_5:
   INST_SUB(cpu->CX, cpu->BX);
   INST_SHL(cpu->BX, 0x2);
...
//old:COMP«CMP, cpu->AX, 0x80»
   if(CMP_C) goto LAB_LOC_7;
   LAB_LOC_3:
   cpu->AX = MEM_WORD(cpu->DI + 0x6);
   INST_SUB(cpu->AX, MEM_WORD(cpu->DI + 0x18));
//old:COMP«CMP, cpu->AX, 0x80»
   if(CMP_C) goto LAB_LOC_8;
   LAB_LOC_4:
   cpu->AX = MEM_WORD(cpu->DI + 0x2);
   INST_ADD(cpu->AX, MEM_WORD(cpu->DI + 0x18));
//old:COMP«CMP, cpu->AX, 0xfe80»
   if(CMP_A) goto LAB_LOC_9;
   LAB_LOC_5:
   cpu->AX = MEM_WORD(cpu->DI + 0x6);
   INST_ADD(cpu->AX, MEM_WORD(cpu->DI + 0x18));
//old:COMP«CMP, cpu->AX, 0xfe80»
   if(CMP_A) goto LAB_LOC_10;
   LAB_LOC_6:
...
//old:COMP«CMP, cpu->EAX, cpu->EDX»
   if(CMP_G) goto LAB_LOC_7;
   INST_MOVZX(cpu->EDX, MEM_WORD(cpu->BX + 0xa));
//old:COMP«CMP, cpu->EAX, cpu->EDX»
   if(CMP_L) goto LAB_LOC_7;
   goto LAB_LOC_3;
   LAB_LOC_6:
   INST_MOVZX(cpu->EDX, MEM_WORD(cpu->BX + 0xc));
//old:COMP«CMP, cpu->EAX, cpu->EDX»
