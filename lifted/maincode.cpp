...
//;XREF[1]:     1000:507a(c)
   ...
   auto jTmp_2a = INST_ADD(cpu->EDX, cpu->EAX);
   if (SIGNED(jTmp_2a) >= 0) goto LAB_LOC_9;
...
void FUN_keyboard_56df(cpu_ctx *cpu){
   ...
   auto jTmp_2c = INST_AND(cpu->AL, 0x80);
   if (SIGNED(jTmp_2c) >= 0) goto LAB_LOC_1;
