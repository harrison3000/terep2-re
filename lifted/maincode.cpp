...
void f_init(cpu_ctx *cpu){
   MEM_WORD(0x5bba) = -2;
   MEM_WORD(0xec50) = 0x78;
   MEM_DWORD(0x6a) = 0x1800;
   MEM_WORD(0xe9e2) = 0x800;
   MEM_WORD(0xe9e4) = 0xf000;
   MEM_WORD(0xdbc0) = 0x0;
   MEM_WORD(0xdbb8) = 0xa0;
   MEM_WORD(0xdbc2) = 0x13f;
   MEM_WORD(0xdbbc) = 0x0;
   MEM_WORD(0xdbba) = 0x50;
   MEM_WORD(0xdbbe) = 0xc7;
   cpu->DX = 0x1a3d;
   cpu->AL = 0x0;
   cpu->AH = 0x3d;
   DOS3Call(cpu);
...
//;needed now that it runs on paint message
   ...
   if (MEM_BYTE(0x7d) & 0xff) goto LAB_LOC_5;
//;singleplayer
   MEM_WORD(0xdbc0) = 0x0;
   MEM_WORD(0xdbb8) = 0xa0;
   MEM_WORD(0xdbc2) = 0x13f;
   ...
   auto jTmp_0 = INST_DEC(cpu->CX);
   if (jTmp_0 == 0) goto LAB_LOC_1;
...
//;split-screen
   ...
   MEM_WORD(0xdbc2) = 0x13f;
   MEM_WORD(0xdbbc) = 0x0;
   MEM_WORD(0xdbba) = 0x32;
   MEM_WORD(0xdbbe) = 0x62;
   cpu->SI = MEM_WORD(0xa4);
   INST_SHL(cpu->SI, 0x1);
   cpu->SI = MEM_WORD(cpu->SI + 0x5bbc);
   INST_MOVZX(cpu->BX, MEM_BYTE(0x7e));
   ...
   auto jTmp_1 = INST_DEC(cpu->CX);
   if (jTmp_1 == 0) goto LAB_LOC_6;
   INST_ADD(cpu->EAX, cpu->EBX);
   INST_SAR(cpu->EAX, 0x1);
   LAB_LOC_6:
   cpu->EBX = cpu->EAX;
...
//; FWD[2]:     1000:5b01(c),15cd:006f(R)
   ...
   auto jTmp_2 = INST_DEC(cpu->CX);
   if (jTmp_2 == 0) goto LAB_LOC_10;
   INST_ADD(cpu->EAX, cpu->EBX);
   INST_SAR(cpu->EAX, 0x1);
   LAB_LOC_10:
   cpu->EBX = cpu->EAX;
...
//;string
   ...
   INST_INC(giracor);
   FUN_1000_2baa(cpu);
   auto jTmp_3 = INST_TEST(CSD_DAT_keys_571e[78], 0x80);
   if (SIGNED(jTmp_3) <  0) goto LAB_LOC_15;
   if (SIGNED(MEM_WORD(0x11c)) > (int16_t)(0x3e8)) goto LAB_LOC_15;
   INST_ADD(MEM_WORD(0x11c), 0x14);
   LAB_LOC_15:
   auto jTmp_4 = INST_TEST(CSD_DAT_keys_571e[74], 0x80);
   if (SIGNED(jTmp_4) <  0) goto LAB_LOC_16;
   if (SIGNED(MEM_WORD(0x11c)) < (int16_t)(0x32)) goto LAB_LOC_16;
   INST_SUB(MEM_WORD(0x11c), 0x14);
   LAB_LOC_16:
   auto jTmp_5 = INST_TEST(CSD_DAT_keys_571e[53], 0x80);
   if (SIGNED(jTmp_5) <  0) goto LAB_LOC_17;
   if (SIGNED(MEM_WORD(0x11e)) > (int16_t)(0x1000)) goto LAB_LOC_17;
   INST_ADD(MEM_WORD(0x11e), 0x28);
   LAB_LOC_17:
   auto jTmp_6 = INST_TEST(CSD_DAT_keys_571e[55], 0x80);
   if (SIGNED(jTmp_6) <  0) goto LAB_LOC_18;
...
void F_0693(cpu_ctx *cpu){
   ...
   cpu->BX = cpu->CX;
   if(false /*untranslated jump JNS*/) goto LAB_LOC_1;
   INST_NEG(cpu->BX);
   LAB_LOC_1:
...
//;XREF[1]:     1000:56ce(c)
   INST_PUSH(cpu->SI);
   INST_PUSH(cpu->DI);
   auto jTmp_7 = INST_TEST(CSD_DAT_keys_571e[2], 0xc0);
   if (SIGNED(jTmp_7) >= 0) goto LAB_LOC_3;
   LAB_LOC_1:
   auto jTmp_8 = INST_TEST(CSD_DAT_keys_571e[3], 0xc0);
   if (SIGNED(jTmp_8) >= 0) goto LAB_LOC_4;
   LAB_LOC_2:
   INST_POP(cpu->DI);
   INST_POP(cpu->SI);
   return;
...
//;XREF[2]:     1000:0a66(c),1000:0a7d(c)
   ...
   INST_POPF();
   if(false /*untranslated jump JP*/) goto LAB_LOC_3;
   INST_INC(cpu->DI);
   INST_INC(cpu->DI);
   cpu->DX = cpu->DI;
...
//;XREF[3]:     1000:02cc(c),1000:0398(c),1000:0458(c)
   ...
   INST_PUSH(cpu->AX);
   INST_PUSH(cpu->BX);
   if (!(MEM_BYTE(0x5fb) & 0x1)) goto LAB_LOC_2;
   INST_XCHG(cpu->AX, cpu->BX);
   LAB_LOC_2:
...
//;XREF[1]:     1000:56cb(c)
   ...
   if (cpu->DI >= MEM_WORD(0x3e51)) goto LAB_LOC_4;
   LAB_LOC_1:
   auto jTmp_9 = INST_SUB(MEM_WORD(cpu->DI + 0x3e6b), 0x2);
   if (SIGNED(jTmp_9) <  0) goto LAB_LOC_8;
   ...
   INST_POP(cpu->BX);
   INST_POP(cpu->AX);
   if(false /*untranslated jump JNS*/) goto LAB_LOC_6;
...
//;XREF[1]:     1000:56b4(c)
   ...
   cpu->CX = 0x32;
   auto jTmp_a = INST_TEST(cpu->AL, 0x80);
   if (SIGNED(jTmp_a) <  0) goto LAB_LOC_2;
   ...
   LAB_LOC_2:
   auto jTmp_b = INST_TEST(cpu->AH, 0x80);
   if (SIGNED(jTmp_b) <  0) goto LAB_LOC_4;
   ...
   if (SIGNED(cpu->BX) >= 0) goto LAB_LOC_5;
   INST_NEG(cpu->CX);
   LAB_LOC_5:
   INST_SUB(cpu->BX, cpu->CX);
   LAB_LOC_6:
   ...
   auto jTmp_c = INST_TEST(cpu->AL, 0x80);
   if (SIGNED(jTmp_c) <  0) goto LAB_LOC_9;
   ...
   INST_SUB(cpu->BX, cpu->CX);
   LAB_LOC_9:
   auto jTmp_d = INST_TEST(cpu->AH, 0x80);
   if (SIGNED(jTmp_d) <  0) goto LAB_LOC_11;
   ...
   if (CSD_DAT_keys_571e[cpu->BX] & 0x80) goto LAB_LOC_14;
   INST_OR(cpu->AX, 0x1);
   LAB_LOC_14:
...
//;XREF[1]:     1000:4b6f(c)
   ...
   return;
   LAB_LOC_3:
   if (CSD_WORD_1000_0e67 & 0x1) goto LAB_LOC_4;
   FUN_1000_1136(cpu);
   INST_OR(CSD_WORD_1000_0e67, 0x1);
   LAB_LOC_4:
   cpu->EAX = CSD_DWORD_1000_12a7;
   ...
   return;
   LAB_LOC_5:
   if (CSD_WORD_1000_0e67 & 0x2) goto LAB_LOC_6;
   INST_PUSH(cpu->SI);
   INST_ADD(cpu->SI, MEM_WORD(cpu->SI));
   INST_ADD(cpu->SI, 0x2);
   FUN_1000_10b6(cpu);
   ...
   return;
   LAB_LOC_7:
   if (CSD_WORD_1000_0e67 & 0x2) goto LAB_LOC_8;
   INST_PUSH(cpu->SI);
   INST_ADD(cpu->SI, MEM_WORD(cpu->SI));
   INST_ADD(cpu->SI, 0x2);
   FUN_1000_10b6(cpu);
...
//;XREF[1]:     1000:56b7(c)
   ...
   INST_ADD(cpu->BX, 0x4);
   if (--cpu->CX != 0) goto LAB_LOC_1;
   if (!(MEM_WORD(cpu->SI + 0xe) & 0x1)) goto LAB_LOC_3;
   cpu->CX = 0x10;
   cpu->BX = 0x0;
   LAB_LOC_2:
   cpu->EAX = MEM_DWORD(cpu->BX + cpu->SI + 0x42);
   ...
   auto jTmp_e = INST_DEC(cpu->BX);
   if (jTmp_e == 0) goto LAB_LOC_5;
...
//;             1000:142f(*),1000:1431(*)
   ...
   INST_SAHF();
   INST_LODSW();
   if(false /*untranslated jump JS*/) goto L_1408_START;
   INST_ADD(cpu->SI, cpu->AX);
   goto L_1408_START;
   LAB_LOC_5:
   cpu->AL = MEM_BYTE(0x5ee);
   INST_SAHF();
   INST_LODSW();
   if(false /*untranslated jump JNS*/) goto L_1408_START;
   INST_ADD(cpu->SI, cpu->AX);
   goto L_1408_START;
   LAB_LOC_6:
   INST_LODSW();
   ...
   INST_LODSW();
   cpu->CL = cpu->AL;
   if(false /*untranslated jump JL*/) goto L_1408_START;
   ...
   MEM_BYTE(0x5ee) = cpu->AL;
   INST_POP(cpu->SI);
   if (SIGNED(cpu->DX) <  0) goto L_1408_START;
   FUN_1000_2bec(cpu);
   goto L_1408_START;
   LAB_LOC_11:
   goto L_1408_START;
   ...
   cpu->AL = MEM_BYTE(0x5ee);
   INST_SAHF();
   if(false /*untranslated jump JS*/) goto LAB_LOC_25;
   INST_PUSH(cpu->SI);
   cpu->AX = MEM_WORD(cpu->SI);
   INST_ADD(cpu->SI, cpu->AX);
   FUN_1000_1408(cpu);
...
//;jumping to another function, some kind of tail call optimization
   auto jTmp_f = INST_TEST(cpu->AH, 0x60);
   if (!PARITY(jTmp_f)) goto FUN_1965_NP;
   MEM_BYTE(0x5fb) = 0x0;
   FUN_1000_3fd0(cpu);
   cpu->AX = MEM_WORD(0xc6);
   auto jTmp_g = INST_TEST(cpu->AH, 0xa0);
   if (!PARITY(jTmp_g)) goto LAB_LOC_12;
   cpu->DI = 0x5bbc;
   cpu->CX = MEM_WORD(0x5bba);
   LAB_LOC_1:
   INST_PUSH(cpu->CX);
...
//;XREF[4]:     1000:1a45(c),1000:1afb(c),1000:1bf0(c),1000:1ca3(c)
   ...
   cpu->SI = 0xdb16;
   FUN_1000_2662(cpu);
   if (SIGNED(cpu->DX) >= 0) goto LAB_LOC_1;
   FUN_1000_2bec(cpu);
   LAB_LOC_1:
   cpu->SI = cpu->DI + 0xa; //HARDCODED LEA!
   cpu->EBX = 0;
   ...
   cpu->SI = 0xdb16;
   FUN_1000_2662(cpu);
   if (SIGNED(cpu->DX) >= 0) goto LAB_LOC_3;
   cpu->AX = MEM_WORD(0xdb12);
   if (!(cpu->AL & 0xf)) goto LAB_LOC_2;
   ...
   cpu->SI = 0xdb16;
   FUN_1000_2662(cpu);
   if (SIGNED(cpu->DX) >= 0) goto LAB_LOC_5;
   FUN_1000_36fe(cpu);
   LAB_LOC_5:
   cpu->SI = cpu->DI + 0xa; //HARDCODED LEA!
   cpu->EBX = MEM_DWORD(0x1d4d);
   ...
   cpu->SI = 0xdb16;
   FUN_1000_2662(cpu);
   if (SIGNED(cpu->DX) >= 0) goto LAB_LOC_6;
   FUN_1000_36fe(cpu);
   LAB_LOC_6:
   INST_POP(cpu->FS);
   return;
...
void FUN_1965_NP(cpu_ctx *cpu){
   ...
   FUN_1000_41b2(cpu);
   cpu->AX = MEM_WORD(0xc6);
   auto jTmp_h = INST_TEST(cpu->AH, 0xc0);
   if (SIGNED(jTmp_h) >= 0) goto LAB_LOC_13;
   cpu->DI = 0x5bbc;
   cpu->CX = MEM_WORD(0x5bba);
   LAB_LOC_2:
   INST_PUSH(cpu->CX);
...
//;XREF[1]:     1000:1998(c)
   ...
   LAB_LOC_4:
   INST_ADD(cpu->SI, 0x1c);
   auto jTmp_i = INST_DEC(cpu->BP);
   if (jTmp_i != 0) goto LAB_LOC_1;
   INST_POP(cpu->SI);
...
//;XREF[1]:     1000:1b44(c)
   ...
   LAB_LOC_4:
   INST_ADD(cpu->SI, 0x1c);
   auto jTmp_j = INST_DEC(cpu->BP);
   if (jTmp_j != 0) goto LAB_LOC_1;
   INST_POP(cpu->SI);
   MEM_WORD(cpu->SI + 0x1a) = cpu->BX;
   return;
   LAB_LOC_5:
...
//;XREF[1]:     1000:1fab(c)
   ...
   LAB_LOC_4:
   INST_ADD(cpu->SI, 0x1c);
   auto jTmp_k = INST_DEC(cpu->BP);
   if (jTmp_k != 0) goto LAB_LOC_1;
   INST_POP(cpu->SI);
   MEM_WORD(cpu->SI + 0x1a) = cpu->BX;
   return;
   LAB_LOC_5:
...
//;XREF[1]:     1000:2155(c)
   ...
   LAB_LOC_4:
   INST_ADD(cpu->SI, 0x1c);
   auto jTmp_l = INST_DEC(cpu->BP);
   if (jTmp_l != 0) goto LAB_LOC_1;
   INST_POP(cpu->SI);
   MEM_WORD(cpu->SI + 0x1a) = cpu->BX;
   return;
   LAB_LOC_5:
...
//;             1000:2722(c)
   ...
   INST_PUSH(cpu->BX);
   FUN_1000_2b08(cpu);
   auto jTmp_m = INST_TEST(cpu->AH, 0x60);
   if ( PARITY(jTmp_m)) goto LAB_LOC_1;
   cpu->BX = cpu->AX;
   FUN_1000_2aad(cpu);
...
//;             1000:4a65(c),1000:4b90(c),1000:57c1(c)
   ...
   cpu->AX = MEM_WORD(cpu->BX + 0xd10c);
   INST_POP(cpu->BX);
   auto jTmp_n = INST_TEST(cpu->BH, 0xc0);
   if ( PARITY(jTmp_n)) goto LAB_LOC_3;
   INST_NEG(cpu->AX);
   LAB_LOC_3:
   return;
}
...
//;             1000:4a5a(c),1000:4c64(c),1000:57c7(c)
   ...
   if(false /*untranslated jump JNZ*/) goto FUN_1000_2b1f;
   cpu->AX = 0x0;
   if (SIGNED(cpu->BX) >= 0) goto LAB_LOC_1;
   INST_ADD(cpu->AX, 0x8000);
   LAB_LOC_1:
...
//;XREF[2]:     1000:2b0e(j),1000:2b63(c)
   if (SIGNED(cpu->BX) <  0) goto LAB_LOC_1;
   if(false /*untranslated jump JNZ*/) goto FUN_1000_2b2d;
   cpu->AX = 0x4000;
   return;
   LAB_LOC_1:
   INST_NOT(cpu->BX);
...
//;XREF[1]:     1000:2c45(c)
   ...
   auto jTmp_o = INST_SUB(cpu->DX, cpu->BX);
   if (jTmp_o == 0) goto LAB_LOC_4;
   INST_INC(cpu->DX);
   INST_SHL(cpu->BX, 0x2);
   INST_PUSH(cpu->ES);
   cpu->ES = MEM_WORD(0xdb10);
   ...
   auto jTmp_p = INST_SUB(cpu->CX, cpu->AX);
   if (SIGNED(jTmp_p) >= 0) goto LAB_LOC_2;
   INST_ADD(cpu->AX, cpu->CX);
   INST_NEG(cpu->CX);
   LAB_LOC_2:
   INST_INC(cpu->CX);
   ...
   LAB_LOC_3:
   INST_ADD(cpu->SI, 0x4);
   auto jTmp_q = INST_DEC(cpu->DX);
   if (jTmp_q != 0) goto LAB_LOC_1;
   INST_POP(cpu->ES);
   LAB_LOC_4:
   return;
   LAB_LOC_5:
   ...
   cpu->AX = MEM_WORD(cpu->SI + 0xdbc8);
   cpu->CX = MEM_WORD(cpu->SI + 0xdbca);
   auto jTmp_r = INST_SUB(cpu->CX, cpu->AX);
   if (SIGNED(jTmp_r) >= 0) goto LAB_LOC_7;
   INST_ADD(cpu->AX, cpu->CX);
   INST_NEG(cpu->CX);
   LAB_LOC_7:
   INST_INC(cpu->CX);
   ...
   if (--cpu->CX != 0) goto LAB_LOC_8;
   INST_ADD(cpu->SI, 0x4);
   auto jTmp_s = INST_DEC(cpu->DX);
   if (jTmp_s != 0) goto LAB_LOC_6;
   INST_POP(cpu->ES);
   return;
}
...
//;XREF[1]:     1000:2bf4(c)
   ...
   INST_PUSH(cpu->AX);
   INST_PUSH(cpu->BX);
   auto jTmp_t = INST_SUB(cpu->CX, MEM_WORD(0xdbc0));
   if (jTmp_t == 0) goto LAB_LOC_4;
...
//;XREF[1]:     1000:2bf9(c)
   ...
   INST_XCHG(cpu->AX, cpu->CX);
   INST_XCHG(cpu->DX, cpu->BX);
   auto jTmp_u = INST_SUB(cpu->CX, MEM_WORD(0xdbc2));
   if (jTmp_u == 0) goto LAB_LOC_4;
...
//;XREF[1]:     1000:2bfe(c)
   ...
   INST_XCHG(cpu->AX, cpu->BX);
   INST_XCHG(cpu->DX, cpu->CX);
   auto jTmp_v = INST_SUB(cpu->CX, MEM_WORD(0xdbbc));
   if (jTmp_v == 0) goto LAB_LOC_4;
...
//;XREF[1]:     1000:2c03(c)
   ...
   INST_XCHG(cpu->AX, cpu->BX);
   INST_XCHG(cpu->DX, cpu->CX);
   auto jTmp_10 = INST_SUB(cpu->CX, MEM_WORD(0xdbbe));
   if (jTmp_10 == 0) goto LAB_LOC_4;
...
//;XREF[1]:     1000:3177(c)
   cpu->BX = MEM_WORD(0xdbc4);
   cpu->DX = MEM_WORD(0xdbc6);
   auto jTmp_11 = INST_SUB(cpu->DX, cpu->BX);
   if (jTmp_11 == 0) goto LAB_LOC_4;
   INST_INC(cpu->DX);
   INST_SHL(cpu->BX, 0x2);
   INST_PUSH(cpu->ES);
   cpu->ES = MEM_WORD(0xdb10);
   ...
   auto jTmp_12 = INST_SUB(cpu->CX, cpu->AX);
   if (SIGNED(jTmp_12) >= 0) goto LAB_LOC_2;
   INST_ADD(cpu->AX, cpu->CX);
   INST_NEG(cpu->CX);
   ...
   INST_POP(cpu->BX);
   INST_ADD(cpu->BX, 0x4);
   auto jTmp_13 = INST_DEC(cpu->DX);
   if (jTmp_13 != 0) goto LAB_LOC_1;
   INST_POP(cpu->ES);
   LAB_LOC_4:
   return;
}
...
//;XREF[1]:     1000:30f6(c)
   ...
   INST_ROR(cpu->EAX, 0x10);
   INST_ROR(cpu->EBX, 0x10);
   auto jTmp_14 = INST_SUB(cpu->CX, MEM_WORD(0xdbc0));
   if (jTmp_14 == 0) goto LAB_LOC_5;
   INST_SUB(cpu->AX, MEM_WORD(0xdbc0));
   INST_PUSH(cpu->AX);
   INST_PUSH(cpu->CX);
   FUN_1000_3f7a(cpu);
...
//;XREF[1]:     1000:30fb(c)
   ...
   INST_POP(cpu->AX);
   INST_POP(cpu->CX);
   auto jTmp_15 = INST_DEC(cpu->CX);
   if (jTmp_15 == 0) goto LAB_LOC_2;
   goto LAB_LOC_1;
   LAB_LOC_4:
   INST_PUSH(cpu->AX);
   INST_PUSH(cpu->BX);
   ...
   INST_ROR(cpu->EAX, 0x10);
   INST_ROR(cpu->EBX, 0x10);
   auto jTmp_16 = INST_SUB(cpu->CX, MEM_WORD(0xdbc2));
   if (jTmp_16 == 0) goto LAB_LOC_5;
   INST_SUB(cpu->AX, MEM_WORD(0xdbc2));
   INST_PUSH(cpu->AX);
   INST_PUSH(cpu->CX);
   FUN_1000_3f7a(cpu);
...
//;XREF[1]:     1000:3100(c)
   ...
   INST_XCHG(cpu->AX, cpu->BX);
   INST_XCHG(cpu->DX, cpu->CX);
   auto jTmp_17 = INST_SUB(cpu->CX, MEM_WORD(0xdbbc));
   if (jTmp_17 == 0) goto LAB_LOC_5;
   INST_SUB(cpu->AX, MEM_WORD(0xdbbc));
   INST_PUSH(cpu->AX);
   INST_PUSH(cpu->CX);
   FUN_1000_3f7a(cpu);
...
//;XREF[1]:     1000:3105(c)
   ...
   INST_POP(cpu->AX);
   INST_POP(cpu->CX);
   auto jTmp_18 = INST_DEC(cpu->CX);
   if (jTmp_18 == 0) goto LAB_LOC_2;
   goto LAB_LOC_1;
   LAB_LOC_4:
   INST_PUSH(cpu->AX);
   INST_PUSH(cpu->BX);
   ...
   INST_XCHG(cpu->AX, cpu->BX);
   INST_XCHG(cpu->DX, cpu->CX);
   auto jTmp_19 = INST_SUB(cpu->CX, MEM_WORD(0xdbbe));
   if (jTmp_19 == 0) goto LAB_LOC_5;
   INST_SUB(cpu->AX, MEM_WORD(0xdbbe));
   INST_PUSH(cpu->AX);
   INST_PUSH(cpu->CX);
   FUN_1000_3f7a(cpu);
...
//;XREF[1]:     1000:3795(c)
   ...
   auto jTmp_1a = INST_SUB(cpu->DI, cpu->SI);
   if (jTmp_1a == 0) goto LAB_LOC_5;
   INST_INC(cpu->DI);
   INST_SHL(cpu->SI, 0x2);
   INST_PUSH(cpu->ES);
   cpu->ES = MEM_WORD(0xdb10);
   ...
   INST_SUB(cpu->DX, cpu->BX);
   auto jTmp_1b = INST_SUB(cpu->CX, cpu->AX);
   if (SIGNED(jTmp_1b) >= 0) goto LAB_LOC_2;
   INST_ADD(cpu->AX, cpu->CX);
   INST_NEG(cpu->CX);
   ...
   auto jTmp_1c = INST_DEC(cpu->SI);
   if (jTmp_1c != 0) goto LAB_LOC_3;
   INST_POP(cpu->SI);
   INST_POP(cpu->DI);
   INST_ADD(cpu->SI, 0x4);
   auto jTmp_1d = INST_DEC(cpu->DI);
   if (jTmp_1d != 0) goto LAB_LOC_1;
   INST_POP(cpu->ES);
   LAB_LOC_5:
   return;
   LAB_LOC_6:
...
//;XREF[1]:     1000:3706(c)
   ...
   INST_POP(cpu->AX);
   INST_POP(cpu->CX);
   auto jTmp_1e = INST_DEC(cpu->CX);
   if (jTmp_1e != 0) goto LAB_LOC_1;
   goto LAB_LOC_2;
   LAB_LOC_4:
   INST_PUSH(cpu->AX);
   INST_PUSH(cpu->BX);
   ...
   INST_ROR(cpu->EAX, 0x10);
   INST_ROR(cpu->EBX, 0x10);
   auto jTmp_1f = INST_SUB(cpu->CX, MEM_WORD(0xdbc0));
   if (jTmp_1f == 0) goto LAB_LOC_5;
   INST_SUB(cpu->AX, MEM_WORD(0xdbc0));
   INST_PUSH(cpu->AX);
   INST_PUSH(cpu->CX);
   FUN_1000_3f7a(cpu);
...
//;XREF[1]:     1000:370b(c)
   ...
   INST_POP(cpu->AX);
   INST_POP(cpu->CX);
   auto jTmp_1g = INST_DEC(cpu->CX);
   if (jTmp_1g != 0) goto LAB_LOC_1;
   goto LAB_LOC_2;
   LAB_LOC_4:
   INST_PUSH(cpu->AX);
   INST_PUSH(cpu->BX);
   ...
   INST_ROR(cpu->EAX, 0x10);
   INST_ROR(cpu->EBX, 0x10);
   auto jTmp_1h = INST_SUB(cpu->CX, MEM_WORD(0xdbc2));
   if (jTmp_1h == 0) goto LAB_LOC_5;
   INST_SUB(cpu->AX, MEM_WORD(0xdbc2));
   INST_PUSH(cpu->AX);
   INST_PUSH(cpu->CX);
   FUN_1000_3f7a(cpu);
...
//;XREF[1]:     1000:3710(c)
   ...
   INST_POP(cpu->AX);
   INST_POP(cpu->CX);
   auto jTmp_1i = INST_DEC(cpu->CX);
   if (jTmp_1i != 0) goto LAB_LOC_1;
   goto LAB_LOC_2;
   LAB_LOC_4:
   INST_PUSH(cpu->AX);
   INST_PUSH(cpu->BX);
   ...
   INST_XCHG(cpu->AX, cpu->BX);
   INST_XCHG(cpu->DX, cpu->CX);
   auto jTmp_1j = INST_SUB(cpu->CX, MEM_WORD(0xdbbc));
   if (jTmp_1j == 0) goto LAB_LOC_5;
   INST_SUB(cpu->AX, MEM_WORD(0xdbbc));
   INST_PUSH(cpu->AX);
   INST_PUSH(cpu->CX);
   FUN_1000_3f7a(cpu);
...
//;XREF[1]:     1000:3715(c)
   ...
   INST_POP(cpu->AX);
   INST_POP(cpu->CX);
   auto jTmp_1k = INST_DEC(cpu->CX);
   if (jTmp_1k != 0) goto LAB_LOC_1;
   goto LAB_LOC_2;
   LAB_LOC_4:
   INST_PUSH(cpu->AX);
   INST_PUSH(cpu->BX);
   ...
   INST_XCHG(cpu->AX, cpu->BX);
   INST_XCHG(cpu->DX, cpu->CX);
   auto jTmp_1l = INST_SUB(cpu->CX, MEM_WORD(0xdbbe));
   if (jTmp_1l == 0) goto LAB_LOC_5;
   INST_SUB(cpu->AX, MEM_WORD(0xdbbe));
   INST_PUSH(cpu->AX);
   INST_PUSH(cpu->CX);
   FUN_1000_3f7a(cpu);
...
//;XREF[2]:     1000:4107(c),1000:411c(c)
   ...
   if (cpu->CX == 0) goto LAB_LOC_14;
   INST_PUSH(cpu->DX);
   auto jTmp_1m = INST_SUB(cpu->DX, cpu->AX);
   if (SIGNED(jTmp_1m) <  0) goto LAB_LOC_10;
   cpu->DI = 0;
   cpu->SI = cpu->CX;
   LAB_LOC_7:
   MEM_WORD(cpu->BX + 0xe590) = cpu->AX;
   INST_ADD(cpu->BX, 0x4);
   auto jTmp_1n = INST_SUB(cpu->DI, cpu->DX);
   if (SIGNED(jTmp_1n) >= 0) goto LAB_LOC_9;
   LAB_LOC_8:
   INST_INC(cpu->AX);
   auto jTmp_1o = INST_ADD(cpu->DI, cpu->SI);
   if (SIGNED(jTmp_1o) <  0) goto LAB_LOC_8;
   LAB_LOC_9:
   if (--cpu->CX != 0) goto LAB_LOC_7;
   INST_POP(cpu->AX);
   MEM_WORD(cpu->BX + 0xe590) = cpu->AX;
   ...
   MEM_WORD(cpu->BX + 0xe590) = cpu->AX;
   INST_ADD(cpu->BX, 0x4);
   auto jTmp_1p = INST_SUB(cpu->DI, cpu->DX);
   if (SIGNED(jTmp_1p) >= 0) goto LAB_LOC_13;
   LAB_LOC_12:
   INST_DEC(cpu->AX);
   auto jTmp_1q = INST_ADD(cpu->DI, cpu->SI);
   if (SIGNED(jTmp_1q) <  0) goto LAB_LOC_12;
   LAB_LOC_13:
   if (--cpu->CX != 0) goto LAB_LOC_11;
   INST_POP(cpu->AX);
   MEM_WORD(cpu->BX + 0xe590) = cpu->AX;
...
//;XREF[2]:     1000:42e9(c),1000:42fe(c)
   ...
   if (cpu->CX == 0) goto LAB_LOC_14;
   INST_PUSH(cpu->DX);
   auto jTmp_1r = INST_SUB(cpu->DX, cpu->AX);
   if (SIGNED(jTmp_1r) <  0) goto LAB_LOC_10;
   cpu->DI = 0;
   cpu->SI = cpu->CX;
   LAB_LOC_7:
   MEM_WORD(cpu->BX + 0xe590) = cpu->AX;
   INST_ADD(cpu->BX, 0x4);
   auto jTmp_1s = INST_SUB(cpu->DI, cpu->DX);
   if (SIGNED(jTmp_1s) >= 0) goto LAB_LOC_9;
   LAB_LOC_8:
   INST_INC(cpu->AX);
   auto jTmp_1t = INST_ADD(cpu->DI, cpu->SI);
   if (SIGNED(jTmp_1t) <  0) goto LAB_LOC_8;
   LAB_LOC_9:
   if (--cpu->CX != 0) goto LAB_LOC_7;
   INST_POP(cpu->AX);
   MEM_WORD(cpu->BX + 0xe590) = cpu->AX;
   ...
   MEM_WORD(cpu->BX + 0xe590) = cpu->AX;
   INST_ADD(cpu->BX, 0x4);
   auto jTmp_1u = INST_SUB(cpu->DI, cpu->DX);
   if (SIGNED(jTmp_1u) >= 0) goto LAB_LOC_13;
   LAB_LOC_12:
   INST_DEC(cpu->AX);
   auto jTmp_1v = INST_ADD(cpu->DI, cpu->SI);
   if (SIGNED(jTmp_1v) <  0) goto LAB_LOC_12;
   LAB_LOC_13:
   if (--cpu->CX != 0) goto LAB_LOC_11;
   INST_POP(cpu->AX);
   MEM_WORD(cpu->BX + 0xe590) = cpu->AX;
...
//;             1000:1f41(c)
   ...
   if(false /*untranslated jump JL*/) goto LAB_LOC_1;
...
//;             1000:1f63(c)
   ...
   cpu->AX = MEM_WORD(cpu->SI + 0x2);
   INST_SUB(cpu->AX, MEM_WORD(0x120));
   if(false /*untranslated jump JGE*/) goto LAB_LOC_4;
   MEM_WORD(0xe992) = cpu->AX;
   cpu->AX = MEM_WORD(cpu->SI);
   MEM_WORD(0xe990) = cpu->AX;
   cpu->AX = MEM_WORD(cpu->SI + 0x4);
...
//;XREF[1]:     1000:48d6(c)
   ...
   auto jTmp_24 = INST_CMP(cpu->AX, cpu->CX);
   if (SIGNED(jTmp_24) >= 0) goto LAB_LOC_11;
   LAB_LOC_2:
   cpu->AX = MEM_WORD(cpu->DI + 0x2);
   ...
   auto jTmp_25 = INST_DEC(MEM_WORD(0xe9d4));
   if (jTmp_25 != 0) goto LAB_LOC_1;
   FUN_1000_1003(cpu);
   return;
   LAB_LOC_7:
...
//;             1000:4a6b(c)
   ...
   INST_SHL(cpu->EDX, 0x1);
   auto jTmp_26 = INST_SUB(cpu->EBX, cpu->EDX);
   if (SIGNED(jTmp_26) >= 0) goto LAB_LOC_3;
...
//;XREF[1]:     1000:4c22(c)
   FUN_1000_4c68(cpu);
   if(false /*untranslated jump JG*/) goto LAB_LOC_1;
   INST_PUSH(cpu->ECX);
   FUN_1000_4d96(cpu);
   INST_POP(cpu->ECX);
...
//;XREF[1]:     1000:48d1(c)
   ...
   auto jTmp_27 = INST_AND(cpu->CX, 0xff);
   if (jTmp_27 == 0) goto LAB_LOC_5;
   if(false /*untranslated jump JS*/) goto LAB_LOC_3;
   if (SIGNED(cpu->CX) > (int16_t)(0x1)) goto LAB_LOC_6;
   cpu->ECX = cpu->EBX;
   auto jTmp_28 = INST_SUB(cpu->ECX, cpu->EAX);
   if (jTmp_28 == 0) goto LAB_LOC_3;
...
//;             1000:4ffd(j)
   ...
   LAB_LOC_4:
   INST_ADD(cpu->SI, 0xe);
   auto jTmp_29 = INST_DEC(MEM_WORD(0xe9e6));
   if (jTmp_29 != 0) goto LAB_LOC_1;
   return;
   LAB_LOC_5:
   ...
   cpu->ECX = cpu->EDX;
   INST_SUB(cpu->ECX, cpu->EAX);
   auto jTmp_2a = INST_SAR(cpu->ECX, 0x1);
   if (jTmp_2a == 0) goto LAB_LOC_3;
   cpu->EBX = cpu->EAX;
   MEM_WORD(cpu->DS*1024 + cpu->BP + 0x6) = cpu->BX;
   goto LAB_LOC_2;
   LAB_LOC_8:
...
//;XREF[1]:     1000:501c(c)
   ...
   INST_POP(cpu->CX);
   auto jTmp_2b = INST_DEC(cpu->CX);
   if (jTmp_2b != 0) goto LAB_LOC_1;
   INST_POP(cpu->SI);
   return;
}
...
//;XREF[1]:     1000:507a(c)
   ...
   auto jTmp_2c = INST_ADD(cpu->EDX, cpu->EAX);
   if (SIGNED(jTmp_2c) >= 0) goto LAB_LOC_9;
   ...
   INST_ADD(cpu->DI, 0x1c);
   INST_POP(cpu->CX);
   auto jTmp_2d = INST_DEC(cpu->CX);
   if (jTmp_2d != 0) goto LAB_LOC_1;
   INST_POP(cpu->SI);
   INST_POP(cpu->DI);
   return;
   LAB_LOC_10:
...
void FUN_keyboard_56df(cpu_ctx *cpu){
   ...
   auto jTmp_2e = INST_AND(cpu->AL, 0x80);
   if (SIGNED(jTmp_2e) >= 0) goto LAB_LOC_1;
...
//;XREF[2]:     1000:04e6(c),1000:04f4(c)
   ...
   if(false /*untranslated jump JZ*/) goto LAB_LOC_10;
   INST_INC(cpu->BX);
   goto LAB_LOC_8;
   LAB_LOC_9:
   INST_PUSH(cpu->AX);
