...
I wont be working on this anymore, its just Hooke's Law and a software 3d renderer implemented in x86 assembly after all, take a look at the `improvements` and `win16` branch